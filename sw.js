const CACHE_NAME = "eduhub-shell-v72";
const APP_SHELL = [
  "/",
  "/index.html",
  "/manifest.json",
  ...
  "/js/markdown-math-bootstrap.js?v=72",
  "/js/data.js?v=71",
  "/js/router.js?v=71",
  "/js/pages-core.js?v=71",
  "/js/pages-extra.js?v=71",
  "/js/pages-more.js?v=71",
  "/js/sound-manager.js?v=71",
  "/js/security-utils.js?v=71",
  "/js/supabase.js?v=71",
  "/js/ai-service.js?v=71",
  "/js/billing-service.js?v=71",
  "/js/app.js?v=71",
